...
<form action="./Index.jsp" method="post">
	...
	<div class="column">
    <div class="card">
	<form action="DepletedServlet" method="post">
		<img  src="./Image/cart.jpg" alt="nothing">
		<input class="button" type="submit" value="Show Depleted"/>
	</form>
	</div>
	</div>
	</div>
	<div class="row">
	<% List<List<String>> students = (ArrayList<List<String>>)request.getAttribute("Category");
    for(List<String> temp : students){ %>
  <div class="column">
    <div class="card">
    <img  src="./Image/cart.jpg" alt="nothing">
    	<form action="ProductServlet" method="post">
    		<input type="hidden" value=<%=temp.get(0)%> name="id" />
			<input class="button" type="submit" value=<%=temp.get(1)%> name="submit"/>
		</form>
    </div>
    </div>
    	<%}%>
