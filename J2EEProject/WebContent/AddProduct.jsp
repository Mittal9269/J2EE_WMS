...
<div class="form-group">
    ...
    <div class="input-group-addon">
      ...
      <input type="text" id="catid" name="catid" placeholder="CategoryID">
    </div>
</div>
<div class="form-group">
    <div class="input-group">
...
<div class="form-group">
    ...
    <div class="input-group-addon">
      ...
      <input type="number" id="unitPrice" name="unitPrice" placeholder="unitPrice">
    </div>
</div>
<div class="form-group">
    <div class="input-group">
    <div class="input-group-addon">
      ...
      <input type="number" id="ReorderIndex" name="ReorderIndex" placeholder="ReorderIndex">
    </div>
</div>
<div class="form-group">
		<button type="submit" class="btn btn-primary btn-block btn-login">
